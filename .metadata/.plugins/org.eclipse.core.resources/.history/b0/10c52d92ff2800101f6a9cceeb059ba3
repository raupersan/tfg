    ...
    public static VBox crearVistaVentas(String dbUrl) {
        ...
        exportarBtn.setOnAction(e -> {
            try {
                ...
                PdfWriter.getInstance(document, (java.io.OutputStream) new FileOutputStream("ventas.pdf"));
                document.open();
                ...
                document.add(table);
                document.close();
                alerta("Exportación completada", "El archivo ventas.pdf ha sido creado exitosamente.");
            } catch (Exception ex) {
                ex.printStackTrace();
            }
        });
        ...
        layout.getChildren().addAll(
                ...
                filtroField, buscarBtn, exportarBtn,
